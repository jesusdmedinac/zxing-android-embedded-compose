...
class Intents private constructor() {
    object Scan {
         ...
         * Set the time to finish the scan screen.
         */
        const val MISSING_CAMERA_PERMISSION = "MISSING_CAMERA_PERMISSION"

        /**
         * Set the time to finish the scan screen.
         */
        const val SHOW_MISSING_CAMERA_PERMISSION_DIALOG = "SHOW_MISSING_CAMERA_PERMISSION_DIALOG"

        /**
         * Set the time to finish the scan screen.
         */
        const val MISSING_CAMERA_PERMISSION_DIALOG_MESSAGE =
